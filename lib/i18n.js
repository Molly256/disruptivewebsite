const en = {
  ...
  // ADDED FOR HISTORY
  history:"History",reviewing:"Reviewing",success:"Success",reject:"Reject"
}

const fr = {...en, // keep your fr here, just add these 4 at the end
  history:"Historique",reviewing:"En cours",success:"Réussi",reject:"Rejeté"
}

const ja = {...en,
  history:"履歴",reviewing:"審査中",success:"成功",reject:"拒否"
}

// For short languages just extend en
const sv = {...en, history:"Historik",reviewing:"Granskas",success:"Lyckades",reject:"Avvisad"}
const it = {...en, history:"Cronologia",reviewing:"In Revisione",success:"Successo",reject:"Rifiutato"}
const de = {...en, history:"Verlauf",reviewing:"In Prüfung",success:"Erfolg",reject:"Abgelehnt"}
const no = {...en, history:"Historikk",reviewing:"Gjennomgås",success:"Suksess",reject:"Avvist"}
const ru = {...en, history:"История",reviewing:"На рассмотрении",success:"Успешно",reject:"Отклонено"}
const hu = {...en, history:"Előzmények",reviewing:"Ellenőrzés alatt",success:"Siker",reject:"Elutasítva"}
const pl = {...en, history:"Historia",reviewing:"W trakcie",success:"Sukces",reject:"Odrzucono"}
const sk = {...en, history:"História",reviewing:"Kontroluje sa",success:"Úspech",reject:"Zamietnuté"}
