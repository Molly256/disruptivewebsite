...
export async function POST(req) {
  try {
    ...
    // FIX: go up 3 levels from /app/api/admin to project root
    ...
    let dataArr = require(dataPath)[varName] // read named export
    ...
    const fileContent = `export const ${varName} = ${JSON.stringify(dataArr, null, 2)}` // write named export
