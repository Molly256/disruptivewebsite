...
export default function VipLevels() {
  ...
  const vipData = [
    { id: 1, title: 'VIP1', price: '100 USD', badgeColor: '#5BC0BE', innerBadgeColor: '#A3E2E2', perks: ['Suitable for most data capture scenarios involving light to medium usage','Profit of 0.5% per product data','40 product data per set','Up to 80 data submissions per day','Can complete 2 sets of data submissions per day','No access to other Premium features'] },
    { id: 2, title: 'VIP2', price: '500 USD', badgeColor: '#4A90E2', innerBadgeColor: '#F5A623', perks: ['Premium user have limited access to all features of the platform','Deposit according to our events','Profit of 1.0% per product data','45 product data per set','Up to 90 data submissions per day','Can complete 2 sets of data submissions per day','Better profit and permission','Full access to all other premium features'] },
    { id: 3, title: 'VIP3', price: '1600 USD', badgeColor: '#1ABC9C', innerBadgeColor: '#F39C12', perks: ['Premium user have limited access to all features of the platform','Deposit according to our events','Profit of 1.5% per product data','50 product data per set','Up to 100 data submissions per day','Can complete 2 sets of data submissions per day'] },
    { id: 4, title: 'VIP4', price: '5500 USD', badgeColor: '#F39C12', innerBadgeColor: '#F1C40F', perks: ['Premium user have limited access to all features of the platform','Deposit according to our events','Profit of 2.0% per product data','55 product data per set','Up to 110 product data per day','Can complete 2 sets of data submissions per day','Better profit and permission','Full access to all other premium features'] },
    { id: 5, title: 'VIP5', price: '10000 USD', badgeColor: '#E74C3C', innerBadgeColor: '#F39C12', perks: ['Supreme user gets unlimited access to all features of the platform','Deposits according to our events','Profit of 2.5% per product data','60 product data per set','Up to 120 product data per day','Can complete 2 set of data submissions per day','Better profits and permissions','Full access to all other premium features'] }
  ]
